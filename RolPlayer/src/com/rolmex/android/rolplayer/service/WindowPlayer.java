...
public class WindowPlayer extends Service implements OnInfoListener, OnBufferingUpdateListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("antking_servicestaert", "ok");
        ...
        player_buffer_content = (CenterLayout)viFloatingWindow
                .findViewById(R.id.player_buffer_content);

        player_buffer_content.setLayoutParams(new RelativeLayout.LayoutParams(
                screen_width, getCenterBufferHeight()));
    ...
    public void onDestroy() {
        ...
        Log.e("antking_service_desroy", "destroy");
        this.stopSelf();
    }
