...
import com.rolmex.android.rolplayer.service.MediaPlaybackService;
		...
		android.view.View.OnClickListener
{
	...
	public void initWindow()
	{
		...
		wmParams.height = getCenterBufferHeight(WIDTH,HEIGHT);
	}
	 private int getCenterBufferHeight(int screen_width,int screen_height) {
	...
	private void initialUI()
	{
		...
		String filePath = "http://119.167.146.12/fcs126.56.com/flvdownload/28/18/13950338514hd_clear.flv.mp4?t=_vvdH13rtMTryFzRk7W70w&r=47460&e=1395996812&v=1&s=1&tt=344&sz=24137946&vid=109381429";// "/mnt/sdcard/test.mp4";//
												// 本地地址和网络地址都可以
		try
		{
